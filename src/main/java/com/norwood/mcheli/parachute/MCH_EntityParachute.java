...
public class MCH_EntityParachute extends W_Entity implements IEntitySinglePassenger {
   ...
   public int getType() {
      return (Byte)this.dataManager.get(TYPE);
   }
   ...
   public void onUpdate() {
      ...
      double d2 = this.getEntityBoundingBox().minY + (this.getEntityBoundingBox().maxY - this.getEntityBoundingBox().minY) * 1.0 / 5.0 - 0.125;
