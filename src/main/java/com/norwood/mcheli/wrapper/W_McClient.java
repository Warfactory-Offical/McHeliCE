...
public class W_McClient {
   ...
   public static void playSound(SoundEvent sound, float volume, float pitch) {
      Minecraft.func_71410_x().func_147118_V().func_147682_a(new W_Sound(sound, volume, pitch));
   }

   public static void DEF_playSoundFX(String name, float volume, float pitch) {
      Minecraft.func_71410_x().func_147118_V().func_147682_a(new W_Sound(new ResourceLocation(name), volume, pitch));
   }
