...
public abstract class MCH_RenderAircraft<T extends MCH_EntityAircraft> extends W_Render<T> {
         ...
         if (ac.isSearchLightON()) {
            ...
            while(var13.hasNext()) {
               ...
               for(int i = 0; i < 25; ++i) {
                  ...
                  builder.func_181662_b((double)(MathHelper.func_76126_a(angle) * width), (double)height, (double)(MathHelper.func_76134_b(angle) * width)).func_181669_b(ce.r, ce.g, ce.b, ce.a).func_181675_d();
               }
   ...
   public void drawHitBoxDetail(MCH_BoundingBox bb) {
      ...
      builder.func_181662_b((double)(-i - 1), -1.0D, 0.1D).func_181666_a(0.0F, 0.0F, 0.0F, 0.4F).func_181675_d();
      builder.func_181662_b((double)(-i - 1), 8.0D, 0.1D).func_181666_a(0.0F, 0.0F, 0.0F, 0.4F).func_181675_d();
      builder.func_181662_b((double)(i + 1), 8.0D, 0.1D).func_181666_a(0.0F, 0.0F, 0.0F, 0.4F).func_181675_d();
      builder.func_181662_b((double)(i + 1), -1.0D, 0.1D).func_181666_a(0.0F, 0.0F, 0.0F, 0.4F).func_181675_d();
      tessellator.func_78381_a();
      GL11.glEnable(3553);
         ...
         while(var6.hasNext()) {
            ...
            if (MCH_Config.TestMode.prmBool) {
               ...
               for(L = 0; L < c.cx.length; ++L) {
                  builder.func_181662_b((double)c.z, c.cx[L], c.cy[L]).func_181669_b((int)(255.0F / (float)c.cx.length * (float)L), 80, 255 - (int)(255.0F / (float)c.cx.length * (float)L), 255).func_181675_d();
               }
      ...
      if (info.haveHatch() && ac.partHatch != null) {
         ...
         while(var5.hasNext()) {
            ...
            if (h.isSlide) {
               ...
               GL11.glTranslated(h.pos.field_72450_a * (double)f, h.pos.field_72448_b * (double)f, h.pos.field_72449_c * (double)f);
            } else {
               GL11.glTranslated(h.pos.field_72450_a, h.pos.field_72448_b, h.pos.field_72449_c);
   ...
   public static void renderThrottle(MCH_EntityAircraft ac, MCH_AircraftInfo info, float tickTime) {
      if (info.havePartThrottle()) {
         ...
         while(var4.hasNext()) {
            ...
            GL11.glTranslated(-h.pos.field_72450_a, -h.pos.field_72448_b, -h.pos.field_72449_c);
            GL11.glTranslated(h.slide.field_72450_a * (double)throttle, h.slide.field_72448_b * (double)throttle, h.slide.field_72449_c * (double)throttle);
            renderPart(h.model, info.model, h.modelName);
            GL11.glPopMatrix();
         }
   ...
   public static void renderWeaponBay(MCH_EntityAircraft ac, MCH_AircraftInfo info, float tickTime) {
      for(int i = 0; i < info.partWeaponBay.size(); ++i) {
         ...
         if (w.isSlide) {
            ...
            float f = pr + (r - pr) * tickTime;
            GL11.glTranslated(w.pos.field_72450_a * (double)f, w.pos.field_72448_b * (double)f, w.pos.field_72449_c * (double)f);
         } else {
            GL11.glTranslated(w.pos.field_72450_a, w.pos.field_72448_b, w.pos.field_72449_c);
      ...
      if (info.haveCanopy() && ac.partCanopy != null) {
         ...
         while(var5.hasNext()) {
            ...
            if (c.isSlide) {
               ...
               float f = pr + (r - pr) * tickTime;
               GL11.glTranslated(c.pos.field_72450_a * (double)f, c.pos.field_72448_b * (double)f, c.pos.field_72449_c * (double)f);
            } else {
               GL11.glTranslated(c.pos.field_72450_a, c.pos.field_72448_b, c.pos.field_72449_c);
      ...
      if (info.haveLandingGear() && ac.partLandingGear != null) {
         ...
         while(var10.hasNext()) {
            ...
            if (n.slide != null) {
               ...
               GL11.glTranslated((double)f * n.slide.field_72450_a, (double)f * n.slide.field_72448_b, (double)f * n.slide.field_72449_c);
            }
                  ...
                  if (gs != null && gs.canLockEntity(entity)) {
                     ...
                     if (dist < 10000.0D) {
                        ...
                        if (isLockEntity) {
                           ...
                           builder.func_181662_b((double)(-size - 1.0F), 0.0D, 0.0D).func_181666_a(1.0F, 0.0F, 0.0F, 1.0F).func_187314_a(0, 240).func_181675_d();
                           builder.func_181662_b((double)(-size - 1.0F), (double)(size * 2.0F), 0.0D).func_181666_a(1.0F, 0.0F, 0.0F, 1.0F).func_187314_a(0, 240).func_181675_d();
                           builder.func_181662_b((double)(size + 1.0F), (double)(size * 2.0F), 0.0D).func_181666_a(1.0F, 0.0F, 0.0F, 1.0F).func_187314_a(0, 240).func_181675_d();
                           builder.func_181662_b((double)(size + 1.0F), 0.0D, 0.0D).func_181666_a(1.0F, 0.0F, 0.0F, 1.0F).func_187314_a(0, 240).func_181675_d();
                        } else {
                           GL11.glLineWidth((float)MCH_Gui.scaleFactor);
                           builder.func_181662_b((double)(-size - 1.0F), 0.0D, 0.0D).func_181666_a(1.0F, 0.3F, 0.0F, 8.0F).func_187314_a(0, 240).func_181675_d();
                           builder.func_181662_b((double)(-size - 1.0F), (double)(size * 2.0F), 0.0D).func_181666_a(1.0F, 0.3F, 0.0F, 8.0F).func_187314_a(0, 240).func_181675_d();
                           builder.func_181662_b((double)(size + 1.0F), (double)(size * 2.0F), 0.0D).func_181666_a(1.0F, 0.3F, 0.0F, 8.0F).func_187314_a(0, 240).func_181675_d();
                           builder.func_181662_b((double)(size + 1.0F), 0.0D, 0.0D).func_181666_a(1.0F, 0.3F, 0.0F, 8.0F).func_187314_a(0, 240).func_181675_d();
                        }
                        ...
                        if (!ac.isUAV() && isLockEntity && Minecraft.func_71410_x().field_71474_y.field_74320_O == 0) {
                           ...
                           builder.func_181662_b(ac.field_70142_S - TileEntityRendererDispatcher.field_147554_b, ac.field_70137_T - TileEntityRendererDispatcher.field_147555_c - 1.0D, ac.field_70136_U - TileEntityRendererDispatcher.field_147552_d).func_181666_a(1.0F, 0.0F, 0.0F, 1.0F).func_187314_a(0, 240).func_181675_d();
                           tessellator.func_78381_a();
                           GL11.glPopMatrix();
                        }
   ...
   public static void renderRope(MCH_EntityAircraft ac, MCH_AircraftInfo info, double x, double y, double z, float tickTime) {
      ...
      if (ac.isRepelling()) {
         ...
         for(int i = 0; i < info.repellingHooks.size(); ++i) {
            ...
            builder.func_181662_b(((MCH_AircraftInfo.RepellingHook)info.repellingHooks.get(i)).pos.field_72450_a, ((MCH_AircraftInfo.RepellingHook)info.repellingHooks.get(i)).pos.field_72448_b, ((MCH_AircraftInfo.RepellingHook)info.repellingHooks.get(i)).pos.field_72449_c).func_181669_b(0, 0, 0, 255).func_181675_d();
            builder.func_181662_b(((MCH_AircraftInfo.RepellingHook)info.repellingHooks.get(i)).pos.field_72450_a, ((MCH_AircraftInfo.RepellingHook)info.repellingHooks.get(i)).pos.field_72448_b + (double)ac.ropesLength, ((MCH_AircraftInfo.RepellingHook)info.repellingHooks.get(i)).pos.field_72449_c).func_181669_b(0, 0, 0, 255).func_181675_d();
            tessellator.func_78381_a();
         }
