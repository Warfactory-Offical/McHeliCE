   ...
   public void execute() {
      ...
      for(int i = 0; i < prm.length; ++i) {
         ...
         case MOTION_X:
            ...
            break;
         case MOTION_Y:
            prm[i] = ac.field_70181_x;
            break;
         case MOTION_Z:
            prm[i] = ac.field_70179_y;
            break;
         case INVENTORY:
         ...
         case PITCH:
            ...
            break;
         case ROLL:
            prm[i] = MathHelper.func_76142_g(ac.getRotRoll());
            break;
         case PLYR_YAW:
            prm[i] = MCH_Lib.getRotate360((double)(player.field_70177_z + 180.0F));
            break;
         case PLYR_PITCH:
            prm[i] = -player.field_70125_A;
            break;
         case TVM_POS_X:
            prm[i] = TVM_PosX;
            break;
         ...
         case KEY_GUI:
            ...
            break;
         case THROTTLE:
            prm[i] = ac.getCurrentThrottle() * 100.0D;
         }
      }
